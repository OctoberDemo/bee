function ListView(ItemFunc) {
    ...
    this.setBackgroundColor = this.setBg;
    ...
    this.appendData = function(datas) {
        ...
        content.measure(content.getMW(), content.getMH() + dataList.length);
    ...
    function ListViewContent() {
        ...
        this.onMeasure = function(wMS, hMS) {
            ...
            var lastW = this.getMW();
            this.setMD(w, h);

            if (w != lastW) {
                this.layoutAtPosition();
            }
        };
